...
if __name__ == "__main__":
    # Define the color range for the object you want to track (in HSV)
    lower_color = np.array([85, 127, 127], dtype=np.uint8)  # Lower HSV values for #33FFD6 (turquoise)
    upper_color = np.array([100, 255, 255], dtype=np.uint8)  # Upper HSV values for #33FFD6 (turquoise)
