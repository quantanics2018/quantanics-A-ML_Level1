...
model.save('mymodel.keras', save_format='tf')
...
test_image=image.load_img(r'D:/Downloads/AI/AI_DeepLearning/FaceMaskDetector-master/30.jpg', target_size=(150,150,3))
test_image
